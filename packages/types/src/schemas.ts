...
export const createProductSchema = z.object({
  ...
  reorderPointUnit: z.string().trim().min(1).max(20).transform((value) => value.toUpperCase()).default("PIECE"),
...
export const updateProductSchema = z.object({
  ...
  reorderPointUnit: z.string().trim().min(1).max(20).transform((value) => value.toUpperCase()).optional(),
