...
export const saleLines = pgTable(
  "sale_lines",
  {
    ...
    /** Selling unit for this line — piece or case */
    unit: varchar("unit", { length: 10 }).notNull().default("piece"),
    /** Computed total pieces for inventory deduction (e.g., qty=2, unit=case, piecesPerCase=24 -> 48) */
