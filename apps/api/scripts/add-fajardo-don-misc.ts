...
const ENTRIES = [
  { date: "2025-10-20", ref: "CM-3018", amount: "1200.00", type: "CREDIT_NOTE" as const, notes: "Credit Memo" },
  { date: "2025-10-29", ref: "CM-3019", amount: "2750.00", type: "CREDIT_NOTE" as const, notes: "Credit Memo" },
  { date: "2026-03-20", ref: "Q3792",   amount: "3100.00",  type: "CHARGE" as const,      notes: "Credit Sale" },
];
...
async function main() {
  ...
  for (const e of ENTRIES) {
    ...
    await db.insert(customerTransactions).values({
      orgId: ORG_ID, customerId: cust.id, type: e.type, amount: e.amount, balanceAfter: "0",
      referenceType: e.type === "CREDIT_NOTE" ? "credit_memo" : "credit_sale",
      referenceNumber: e.ref, notes: e.notes, recordedAt: new Date(e.date),
    });
    inserted++;
  }
