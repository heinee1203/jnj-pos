/**
 * Add 3 CHARGE transactions for LGU - Ocampo.
 * Run: npx tsx apps/api/scripts/add-lgu-ocampo.ts
 */
...
const NEW_ENTRIES = [
  { date: "2025-09-30T00:00:00Z", ref: "Q2191", amount: "9000.00" },
  { date: "2025-10-10T00:00:00Z", ref: "Q1939", amount: "4250.00" },
  { date: "2025-10-14T00:00:00Z", ref: "Q1944", amount: "9000.00" },
];

async function main() {
  console.log("=== Add LGU - Ocampo Transactions ===\n");
  ...
  if (!customer) {
    const [created] = await db.insert(customers).values({
      orgId: ORG_ID, name: "LGU - Ocampo", phone: "N/A", customerType: "GOVERNMENT", currentBalance: "0", totalPurchases: "0", isActive: true,
  ...
  const existing = await db.execute(
    sql`SELECT reference_number FROM customer_transactions WHERE customer_id = ${customer.id} AND reference_number IN ('Q1939','Q1944','Q2191')`
  ) as any[];
