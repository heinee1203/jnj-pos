...
const ENTRIES = [
  { date: "2025-03-30", ref: "Q0259", amount: "150.00" },
  { date: "2025-04-03", ref: "Q0289", amount: "690.00" },
  { date: "2025-06-20", ref: "Q1127", amount: "1200.00" },
  { date: "2025-07-21", ref: "Q1462", amount: "350.00" },
  { date: "2025-08-13", ref: "Q1740", amount: "1000.00" },
  { date: "2025-09-03", ref: "Q1891", amount: "3250.00" },
  { date: "2025-09-11", ref: "Q2069", amount: "400.00" },
  { date: "2025-11-11", ref: "Q2658", amount: "3600.00" },
  { date: "2025-11-15", ref: "Q2687", amount: "2200.00" },
  { date: "2025-11-19", ref: "Q2715", amount: "1500.00" },
  { date: "2025-12-23", ref: "Q3021", amount: "3800.00" },
];

async function main() {
  const [cust] = await db.select({ id: customers.id, name: customers.name })
    .from(customers).where(and(eq(customers.orgId, ORG_ID), sql`UPPER(${customers.name}) = 'CHENG AUTO SUPPLY'`));
