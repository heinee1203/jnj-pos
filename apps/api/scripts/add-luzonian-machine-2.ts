/**
 * Add Q2665 and Q2703 for Luzonian Machine Shop.
 * Run: npx tsx apps/api/scripts/add-luzonian-machine-2.ts
 */
...
const NEW_ENTRIES = [
  { date: "2025-11-13T00:00:00Z", ref: "Q2665", amount: "9000.00" },
  { date: "2025-11-18T00:00:00Z", ref: "Q2703", amount: "300.00" },
];

async function main() {
  console.log("=== Add Luzonian Machine Shop Q2665 + Q2703 ===\n");
  ...
  const existing = await db.execute(
    sql`SELECT reference_number FROM customer_transactions WHERE customer_id = ${customer.id} AND reference_number IN ('Q2665','Q2703')`
  ) as any[];
