...
import type { SalesByEmployeeController } from "../types";

type SalesByEmployeeFiltersProps = {
  controller: SalesByEmployeeController;
};

export function SalesByEmployeeFilters({ controller }: SalesByEmployeeFiltersProps) {
  return (
