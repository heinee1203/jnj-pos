...
import type { SalesByCategoryController } from "../types";

type SalesByCategoryFiltersProps = {
  controller: SalesByCategoryController;
};

export function SalesByCategoryFilters({ controller }: SalesByCategoryFiltersProps) {
  return (
